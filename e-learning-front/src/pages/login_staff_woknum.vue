<template>
  <div class="bg">
    ...
    <div class="container">
      ...
      <div class="right">
        <p>工号登录</p>
        <el-input placeholder="请输入工号" v-model="wNum" maxlength="6" show-word-limit>
          <template slot="prepend"><img src="../assets/iconfont/setting.png"></template>
        </el-input>
        <el-input placeholder="请输入密码" v-model="password" maxlength="15" minlength="6" show-password>
          <template slot="prepend"><img src="../assets/iconfont/account-2.png"></template>
        </el-input>
        <span class="change" @click="goTo">....... 切换手机号登录</span>
        <br>
        <br>
...
export default {
  ...
  methods: {
    ...
    login () {
      if (this.wNum && this.password) loginStaff(null, this.wNum, this.password)
      else alert('请填写完整！')
    },
    reg () {
...
<style scoped>
  .bg{
    ...
    height: 100%;
    padding: 10%;
    background-image: url("../assets/img/staff_bg2.jpg");
    background-size: 100%;
